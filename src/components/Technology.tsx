...
export default function Technology({ feachedPromise }: techProp) {
  ...
  return (
    <div className="container mx-auto space-y-3.5 px-2.5 lg:px-0">
      ...
      <div className="grid grid-cols-12 pt-8 gap-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 col-span-12 lg:col-span-9">
